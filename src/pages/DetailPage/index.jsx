    ...
    <article className="flex items-center gap-1 flex-col w-full">
      ...
      >
        ...
        <section className="w-full flex flex-col z-20 items-center justify-end relative h-full">
          ...
          <div className="relative h-auto m-w-[15.5rem] z-20 mt-6 -mb-16">
            <img
              src={img}
              width="100%"
              height="auto"
        ...
        <section className="w-full mix-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5 pb-4">
